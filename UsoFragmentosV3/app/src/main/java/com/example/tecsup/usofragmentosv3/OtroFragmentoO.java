 ...
 * {@link OtroFragmentoO.OnFragmentInteractionListener} interface
 * to handle interaction events.
 */
public class OtroFragmentoO extends Fragment {

    private OnFragmentInteractionListener mListener;

    public OtroFragmentoO() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_otro_fragmento_o, container, false);
